...
BASE_ENTRIES: List[PaletteEntry] = [
    ...
    PaletteEntry(label="New Session", hint="Create collaboration session", command="/session new"),
    PaletteEntry(label="Join Session", hint="Join shared session", command="/session join"),
    PaletteEntry(label="Session Analytics", hint="Summarise KPIs", command="/analytics"),
    PaletteEntry(label="Dashboard", hint="Open analytics dashboard", command="/dashboard"),
    PaletteEntry(label="Insights", hint="Generate narrative summary", command="/insights"),
    PaletteEntry(label="Sync", hint="Push/pull collaboration state", command="/sync"),
    PaletteEntry(label="Reports", hint="Export metrics report", command="/reports"),
    PaletteEntry(label="Compare Sessions", hint="Diff session analytics", command="/compare"),
    PaletteEntry(label="Project Status", hint="Summarise milestones", command="/project status"),
    PaletteEntry(label="Project Plan", hint="Generate roadmap", command="/project plan"),
    PaletteEntry(label="Pipeline Run", hint="Execute build/test stages", command="/pipeline run"),
    PaletteEntry(label="Pipeline Dashboard", hint="Overview pipeline history", command="/pipeline dashboard"),
    PaletteEntry(label="Release Tag", hint="Create release record", command="/release tag"),
    PaletteEntry(label="Release Rollback", hint="Rollback release", command="/release rollback"),
    PaletteEntry(label="Governance Audit", hint="Validate compliance policies", command="/govern"),
    PaletteEntry(label="Team Analytics", hint="Per-node metrics", command="/team analytics"),
    PaletteEntry(label="Team Broadcast", hint="Send message to collaborators", command="/broadcast"),
]
